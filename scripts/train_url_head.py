...
from phisdom.data.new_heads import UrlSeqDataset, PaddedSeqCollator
from phisdom.models.heads import UrlCharCNN
...
def main():
    ap = argparse.ArgumentParser(description="Train URL Char-CNN head and calibrate")
    ap.add_argument("--train-jsonl", required=True)
    ap.add_argument("--val-jsonl", required=True)
    ap.add_argument("--output-dir", default="artifacts/url_head")
    ...
    if val_logits.numel():
        ...
        # Save raw logits for optional external calibration/plots
